...
const userCollection = (0, _user.User).buildUserCollection();
...
class User extends (0, _model.Model) {
    ...
    static buildUserCollection() {
        return new (0, _collection.Collection)(ROOT_URL, (json)=>User.buildUser(json));
    }
}
...
var Buffer = require("d5f93fa09f18be04").Buffer;
"use strict";
/**
...
},{"d5f93fa09f18be04":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("fdd753c1a496d1ce");
var ieee754 = require("5149bebdc8e319d9");
...
},{"fdd753c1a496d1ce":"eIiSV","5149bebdc8e319d9":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
var _eventing = require("./Eventing");
class Collection {
    constructor(ROOT_URL, deserialize){
    ...
    fetch() {
        (0, _axiosDefault.default).get(this.ROOT_URL).then((response)=>{
...
},{"axios":"jo6P5","./Eventing":"7459s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequire2d1f")
